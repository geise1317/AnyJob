package com.example.anyjob.view;
...
public class ContentsItemView extends LinearLayout {
    ...
    public ContentsItemView(Context context, @org.jetbrains.annotations.Nullable AttributeSet attributeSet) {
    ...
    public void setImage(String path){
        Glide.with(this).load(path).override(300).into(imageView);
    }
